...
PROMPTS = {
    "สรุปประเด็นหลัก + Action Items": """
สรุปการประชุมต่อไปนี้เป็นภาษาไทย โดยแบ่งเป็น:
...
""",
    "สรุปแบบละเอียด": """
สรุปการประชุมต่อไปนี้แบบละเอียดเป็นภาษาไทย ครอบคลุมทุกประเด็นที่หารือ การตัดสินใจ ข้อถกเถียง และผลสรุป
""",
    "เฉพาะ Action Items": """
จากการประชุมต่อไปนี้ ให้ระบุ Action Items ทั้งหมด พร้อมผู้รับผิดชอบและ deadline (ถ้ามีการกล่าวถึง) เป็นภาษาไทย
""",
    "Minutes of Meeting (MOM)": """
เขียน Minutes of Meeting (MOM) ภาษาไทยจากการประชุมต่อไปนี้ ประกอบด้วย:
